...
#  
# 
#  Related Topics Array Hash Table String 👍 2098 👎 265
...
class Solution:
    def numUniqueEmails(self, emails: List[str]) -> int:
        ...
        def check(email: str) -> bool:
            ...
            plus_detected = False
            while email[index] != "@":
                if plus_detected or email[index] == ".":
                    index += 1
                    continue
                if email[index] == "+":
                    plus_detected = True
            ...
            unique_emails.add(local + "@" + email[index + 1:])
            return True
...
# solution.numUniqueEmails(["fg.r.u.uzj+o.pw@kziczvh.com",
